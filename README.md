...
<table style='width: 100%; border-collapse: collapse; text-align: center;'>
    <tr>
        <td style='width: 50%; height: 30px; border:dotted; border-color: #1b7632;'>Backend</td>
        <td style='height: 30px; border:dotted; border-color: #1b7632;'>Frontend</td>
    </tr> 
    <tr>
        <td style='width: 50%; height: 30px; border:dotted; border-color: #1b7632;'>
        ...
        <td style='height: 30px; border:dotted; border-color: #1b7632;'>
    ...
    <tr>
        <td style='width: 50%; height: 30px; border:dotted; border-color: #1b7632;'>Databases</td>
        <td style='height: 30px; border:dotted; border-color: #1b7632;'>Tools</td>
    </tr> 
    <tr>
        <td style='width: 50%; height: 30px; border:dotted; border-color: #1b7632;'>
